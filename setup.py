...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "testing.py"
 
        #Name of program
        self.project_name = "RPi Project"
        ...
        self.license = "Do not redistribute! This is still a secret."
 
        #Auhor of program
        self.author_name = "Jack Needham"
        self.author_email = "outrexian@gmail.com"
        self.copyright = "Copyright (c) 2012 Jack Needham."
 
        #Description
        self.project_description = "WIP"
